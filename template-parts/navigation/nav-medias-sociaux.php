...
$args = array(
	'theme_location'  => 'menu-medias-sociaux',
	'menu'            => '',
	'container'       => 'div',
	'container_class' => 'widget-medias-sociaux d-none d-md-block',
	'container_id'    => 'navigation-medias-sociaux',
	'menu_class'      => 'items-medias-sociaux',
	'menu_id'         => '',
	'echo'            => true,
	'fallback_cb'     => 'wp_page_menu',
	'before'          => '',
	'after'           => '',
	'link_before'     => '<span class="d-block">',
	'link_after'      => '</span>',
	'items_wrap'      => '<ul id="%1$s" class="%2$s d-flex align-items-center">%3$s</ul>',
	'depth'           => 0,
	'walker'          => ''
);


if (has_nav_menu('menu-widgets')) {
	wp_nav_menu($args);
}